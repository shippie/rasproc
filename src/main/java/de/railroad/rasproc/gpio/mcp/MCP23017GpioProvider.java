 ...
 * 
 */
public class MCP23017GpioProvider extends GpioProviderBase implements GpioProvider, IMCP23017GpioProvider
{

	public static final String NAMES = "com.pi4j.gpio.extension.mcp.MCP23017GpioProvider";
	...
	/* (non-Javadoc)
	 * @see de.railroad.rasproc.gpio.mcp.IMCP23017GpioProvider#getName()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.railroad.rasproc.gpio.mcp.IMCP23017GpioProvider#export(com.pi4j.io.gpio.Pin, com.pi4j.io.gpio.PinMode)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.railroad.rasproc.gpio.mcp.IMCP23017GpioProvider#unexport(com.pi4j.io.gpio.Pin)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.railroad.rasproc.gpio.mcp.IMCP23017GpioProvider#setMode(com.pi4j.io.gpio.Pin, com.pi4j.io.gpio.PinMode)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.railroad.rasproc.gpio.mcp.IMCP23017GpioProvider#getMode(com.pi4j.io.gpio.Pin)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.railroad.rasproc.gpio.mcp.IMCP23017GpioProvider#setState(com.pi4j.io.gpio.Pin, com.pi4j.io.gpio.PinState)
	 */
	@Override
	public void setState(Pin pin, PinState state)
	{
		...
		if (getPinCache(pin).getMode() != PinMode.DIGITAL_OUTPUT)
		{
			throw new InvalidPinModeException(pin, "Invalid pin mode on pin [" + pin.getName()
				+ "]; cannot setState() when pin mode is [" + getPinCache(pin).getMode().getName() + "]");
		}
		try
		{
			// determine A or B port based on pin address
	...
	/* (non-Javadoc)
	 * @see de.railroad.rasproc.gpio.mcp.IMCP23017GpioProvider#getState(com.pi4j.io.gpio.Pin)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.railroad.rasproc.gpio.mcp.IMCP23017GpioProvider#setPullResistance(com.pi4j.io.gpio.Pin, com.pi4j.io.gpio.PinPullResistance)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.railroad.rasproc.gpio.mcp.IMCP23017GpioProvider#getPullResistance(com.pi4j.io.gpio.Pin)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.railroad.rasproc.gpio.mcp.IMCP23017GpioProvider#shutdown()
	 */
	@Override
