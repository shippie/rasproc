 ...
 *
 * <p>
 * The MCP23008 is connected via I2C connection to the Raspberry Pi and provides 8 GPIO pins that
...
public class MCP23008Pin
{
	...
	{
		return new PinImpl(MCP23008GpioProvider.NAME, address, name, EnumSet.of(PinMode.DIGITAL_INPUT,
